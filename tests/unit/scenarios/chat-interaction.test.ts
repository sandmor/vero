...
import { planBranchSwitch, computeBranchFromSelection } from '@/lib/utils/index';
...
describe('Chat Interaction Scenarios', () => {
  ...
  describe('Mixed Branching (Complex Navigation)', () => {
    it('handles navigation across different levels and branches', () => {
      ...
      const asstB1 = createNode('asst-b1', '0.1.0.0', '0.1.0', 0, 2, 'assistant');
      const asstB2 = createNode('asst-b2', '0.1.0.1', '0.1.0', 1, 2, 'assistant');
