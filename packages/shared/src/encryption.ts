 ...
 */
export function deriveEncryptionKey(stableId: string, secretBase64: string): string {
 ...
 */
export function deriveTestingKey(sessionId: string, testSecret: string): string {
