...
function WidgetConfigItem({ widget, onToggle, onUpdate }: WidgetConfigItemProps) {
    const [expanded, setExpanded] = useState(false);
    const IconComponent = chartTypeIcons[widget.settings.chartType || widget.type] || BarChart3;
                ...
                {expanded && (
                    ...
                    >
                        ...
                        <div className="space-y-3">
                            ...
                            {widget.type === 'time-series' && (
                                <div className="space-y-1.5">
                                    ...
                                    <Select
                                        ...
                                        onValueChange={(value) =>
                                            onUpdate({
                                                settings: { ...widget.settings, chartType: value as ChartType },
                                            })
                                        }
                                    >
                                        <SelectTrigger className="h-8">
                                ...
                                widget.settings.metric !== undefined && (
                                    <div className="space-y-1.5">
                                        ...
                                        <Select
                                            ...
                                            onValueChange={(value) =>
                                                onUpdate({
                                                    settings: { ...widget.settings, metric: value as MetricType },
                                                })
                                            }
                                        >
                                            <SelectTrigger className="h-8">
                            ...
                            {/* Stacked toggle */}
                            {widget.type === 'time-series' && widget.settings.splitByModel && (
                            ...
                            {widget.type === 'table' && (
                                <div className="space-y-1.5">
                                    ...
                                    <Select
                                        ...
                                        onValueChange={(value) =>
                                            onUpdate({
                                                settings: { ...widget.settings, limit: parseInt(value) },
                                            })
                                        }
                                    >
                                        <SelectTrigger className="h-8">
...
export function DashboardConfigurator({ onRefresh, isRefreshing }: DashboardConfiguratorProps) {
    const {
        config,
        isLoading,
        isSaving,
