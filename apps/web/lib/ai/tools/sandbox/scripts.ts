...
export function createBootstrapScript(): string {
  return [
    ...
    'function __vero_format__(value) {',
    ...
    'const __vero_stdout__ = [];',
    'const __vero_stderr__ = [];',
    '',
    '// Set up global state',
    'globalThis.__vero_last_result__ = { status: "ok", value: undefined };',
    'globalThis.__vero_stdout__ = __vero_stdout__;',
    'globalThis.__vero_stderr__ = __vero_stderr__;',
    '',
    '// Override console for output capture',
    'globalThis.console = Object.freeze({',
    '  log: (...args) => __vero_stdout__.push(args.map(__vero_format__).join(" ")),',
    '  info: (...args) => __vero_stdout__.push(args.map(__vero_format__).join(" ")),',
    '  warn: (...args) => __vero_stdout__.push(args.map(__vero_format__).join(" ")),',
    '  error: (...args) => __vero_stderr__.push(args.map(__vero_format__).join(" ")),',
    '});',
  ].join('\n');
}
...
export function createApiScript(locationHints: LocationHints | null): string {
  ...
  return [
    ...
    '  const hostGetWeather = globalThis.__vero_host_get_weather__;',
    '',
    ...
    '  const hostWebScrape = globalThis.__vero_host_web_scrape__;',
    '  const hostWebCrawl = globalThis.__vero_host_web_crawl__;',
    '  const hostWebMap = globalThis.__vero_host_web_map__;',
    '  const hostWebSearch = globalThis.__vero_host_web_search__;',
    '',
...
export function createExecutionScript(code: string): string {
  ...
  return [
    ...
    '    }',
    '    globalThis.__vero_last_result__ = { status: "ok", value: result };',
    '  } catch (error) {',
    '    globalThis.__vero_last_result__ = {',
    '      status: "error",',
    '      error: {',
...
export function createSummaryScript(): string {
  return [
    ...
    '  }',
    '',
    '  const base = globalThis.__vero_last_result__ || { status: "ok", value: undefined };',
    '  const stdout = Array.isArray(globalThis.__vero_stdout__) ? globalThis.__vero_stdout__ : [];',
    '  const stderr = Array.isArray(globalThis.__vero_stderr__) ? globalThis.__vero_stderr__ : [];',
    '',
