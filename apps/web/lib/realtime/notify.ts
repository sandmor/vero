 ...
 */
export async function notifyOnChatCreated(userId: string, chatId: string): Promise<void> {
    try {
 ...
 */
export async function notifyOnChatUpdated(userId: string, chatId: string): Promise<void> {
    try {
 ...
 */
export async function notifyOnChatDeleted(userId: string, chatId: string): Promise<void> {
    try {
 ...
 */
export async function notifyOnChatsDeleted(userId: string, chatIds: string[]): Promise<void> {
    await Promise.all(
